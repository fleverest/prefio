test_that("`preferences` ordinal type is detected appropriately", {
  toc <- read.preflib("../data/aspen00016-00000001.toc")$preferences
  toi <- read.preflib("../data/berkley00017-00000001.toi")$preferences
  soc <- read.preflib("../data/netflix00004-00000101.soc")$preferences
  soi <- read.preflib("../data/glasgow00008-00000003.soi")$preferences
